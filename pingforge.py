...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="PingForge TUI - Real-time multi-host ping monitor")
    parser.add_argument(
        "-c", "--config",
        type=str,
        default="pingforge.conf",
        help="Path to config file (default: pingforge.conf)"
    )
